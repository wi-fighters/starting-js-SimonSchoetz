...
The first letter of your name is ${name[0]}, the last is ${
  name[name.length - 1]
}.
...
Your name is ${nameWOSpace.length} letters long.
The first letter of your name is ${nameTrim[0]}, the last is ${
  nameTrim[nameTrim.length - 1]
}.
If I wanted to be funny, I would call you ${nameTrim.substring(0, 4)}chmoo. `);
*/
